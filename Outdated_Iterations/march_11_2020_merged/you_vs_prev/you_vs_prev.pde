...
void YP_draw() {
  ...
  println("color of current person"); 
  println("RED: " + YP_CURR_COLOR_R); 
  println("GREEN: " + YP_CURR_COLOR_G); 
  println("BLUE: " + YP_CURR_COLOR_B); 
  println(" "); 
  // println("color of previous person"); 
  // println("RED: " + YP_PREV_COLOR_R); 
  // println("GREEN: " + YP_PREV_COLOR_G); 
  // println("BLUE: " + YP_PREV_COLOR_B); 
  // println(" "); 
  ...
  // println("color of intersection"); 
  // println("RED: " + YP_INTERSECT_R); 
  // println("GREEN: " + YP_INTERSECT_G); 
  // println("BLUE: " + YP_INTERSECT_B); 
  // println(" ");
  ...
  for (int i = 0; i < rawBodyData.length; i+=1){
    ...
    // Current body, no intersection
      ...
      if (YP_fadeIntersectionCounter[i] == 0) {
        /*
        float newR = max(40, (red(YP_CURR_PERSON_COLOR)) - (255 * (YP_frameCounter-YP_START_FADE)/(YP_TOT_FRAMES-YP_START_FADE)));
        float newG = max(40, (green(YP_CURR_PERSON_COLOR)) - (255 * (YP_frameCounter-YP_START_FADE)/(YP_TOT_FRAMES-YP_START_FADE)));
        float newB = max(40, (blue(YP_CURR_PERSON_COLOR)) - (255 * (YP_frameCounter-YP_START_FADE)/(YP_TOT_FRAMES-YP_START_FADE))); 
        
        YP_fadedPixels[i] = color(newR, newG, newB);
        */
