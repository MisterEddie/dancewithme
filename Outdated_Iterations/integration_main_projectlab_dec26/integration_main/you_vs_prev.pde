...
// displayText
final String displayTextYP = "In you vs. previous, we look at intersections in space and similarities in joint position between you and the previous person."; 
...
void YP_draw() {
  ...
  if (YP_frameCounter == YP_TOT_FRAMES) {
    ...
    YP_createOutputImage(YP_youAndPrevIntersectionPixels, YP_OUTPUT_FILENAME);
